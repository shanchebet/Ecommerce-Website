                ...
                if ($filesize > 10000000) {
                    ...
                    if ($checkcategoryrows >= 1) {
                        while ($fetchcategory = mysqli_fetch_assoc($querycategory)) {
                            ...
                            $uploadproduct = "INSERT INTO `products`(`product_name`, `product_description`, `product_price`, `product_user_id`, `product_images`, `product_category_id`, `product_sub_category_id`, `product_status`) VALUES ('$product_name', '$product_description','$product_price','$globalsellerid','$filenamenew','$fetchedcategory','$product_sub_category','available')";
