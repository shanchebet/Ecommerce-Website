                                            ...
                                            if ($queryproductsrows >= 1) {
                                                while ($fetch = mysqli_fetch_assoc($queryproducts)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>$categoryname</td>
                                                        <td>$desc</td> 
                                                        <td><a href='edit-sub-category.php?subcategory=$subcatid' class='btn btn-warning'>Edit </a></td>
                                                        <td><a href='delete-subcategory.php?subcategory=$subcatid' class='btn btn-danger'>Delete </a></td>
