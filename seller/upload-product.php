                                        ...
                                        <div class="form-row row">
                                            <div class="col-md-6 mb-4"> 
                                                ...
                                                <select name="product_sub_category" id="" class="form-control">
                                                    ...
                                                    while ($fetchdata = mysqli_fetch_assoc($querysubcategory)) {
                                                        $subname = $fetchdata['sub_category_name'];
                                                        $subid = $fetchdata['sub_category_id'];
                                                        echo "<option value='$subid'>$subid-$subname</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
